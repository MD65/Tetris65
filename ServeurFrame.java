...
/**
 * Frame d'attente de connexion avec un client.
 * @author Alamargot François & Buiguez Arnaud;
 * @version Version 1.0 => Version de base mais alors de base...
 */
...
public class ServeurFrame extends JPanel implements ActionListener {
	...
	private Connection connectFrame;
...
public ServeurFrame(Connection connectFrame) {
	super();
